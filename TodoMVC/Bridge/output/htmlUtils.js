...
Bridge.assembly("Aurelia", function ($asm, globals) {
    ...
    Bridge.define("HtmlUtils.AnyAutoComplete", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyAutoComplete();
    ...
    Bridge.define("HtmlUtils.AnyBool", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyBool();
    ...
    Bridge.define("HtmlUtils.AnyButtonType", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyButtonType();
    ...
    Bridge.define("HtmlUtils.AnyDate", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyDate();
    ...
    Bridge.define("HtmlUtils.AnyDouble", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyDouble();
    ...
    Bridge.define("HtmlUtils.AnyHTMLTableCaptionElement", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyHTMLTableCaptionElement();
    ...
    Bridge.define("HtmlUtils.AnyHTMLTableSectionElement", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyHTMLTableSectionElement();
    ...
    Bridge.define("HtmlUtils.AnyInputType", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyInputType();
    ...
    Bridge.define("HtmlUtils.AnyInt", {
        statics: {
            op_Implicit$1: function (s) {
                var a = new HtmlUtils.AnyInt();
    ...
    Bridge.define("HtmlUtils.AnyString", {
        statics: {
            op_Implicit$1: function (s) {
                var a = new HtmlUtils.AnyString();
    ...
    Bridge.define("HtmlUtils.AnyWrap", {
        statics: {
            op_Implicit: function (s) {
                var a = new HtmlUtils.AnyWrap();
    ...
    Bridge.define("HtmlUtils.IAttributes", {
        $kind: "interface"
    });

    Bridge.define("HtmlUtils.Cell", {
        statics: {
            noNotification: null,
            config: {
                init: function () {
            ...
            op_Implicit: function (value) {
                return new HtmlUtils.Cell(function () {
                    return value;
                }, HtmlUtils.Cell.noNotification);
            }
        },
        source: null,
        notifier: null,
        ...
        ctor: function (_source, _notifier) {
            ...
            _notifier.subscribe(Bridge.fn.bind(this, $asm.$.HtmlUtils.Cell.f1));
        },
    ...
    Bridge.ns("HtmlUtils.Cell", $asm.$);

    Bridge.apply($asm.$.HtmlUtils.Cell, {
        f1: function (_) {
    ...
    Bridge.define("HtmlUtils.HtmlUtil", {
        statics: {
            ...
            initElement: function (T, element, init, children) {
                ...
                init != null ? init.HtmlUtils$IAttributes$initElement(element) : null;

                HtmlUtils.HtmlUtil.appendChildElements(element, children);
            ...
            div: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLDivElement, document.createElement('div'), init, children);
            },
            span: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLSpanElement, document.createElement('span'), init, children);
            },
            p: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLParagraphElement, document.createElement('p'), init, children);
            },
            pre: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLPreElement, document.createElement('pre'), init, children);
            },
            strong: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("strong"), init, children);
            },
            br: function (init) {
                return HtmlUtils.HtmlUtil.initElement(HTMLBRElement, document.createElement('br'), init);
            },
            ol: function (init, children) {
                ...
                HtmlUtils.HtmlUtil.appendChildElements(a, children);

                return a;
            },
            ul: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLUListElement, document.createElement('ul'), init, children);
            },
            li: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLLIElement, document.createElement('li'), init, children);
            },
            main: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("main"), init, children);
            },
            header: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("header"), init, children);
            },
            footer: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("footer"), init, children);
            },
            section: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("section"), init, children);
            },
            nav: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLElement, document.createElement("nav"), init, children);
            },
            HR: function (init) {
                return HtmlUtils.HtmlUtil.initElement(HTMLHRElement, document.createElement('hr'), init);
            },
            a: function (init, children) {
                if (children === void 0) { children = []; }
                var a = document.createElement('a');

                init.HtmlUtils$IAttributes$initAnchorElement(a);
            ...
            image: function (init) {
                ...
                init.HtmlUtils$IAttributes$initImageElement(a);
            ...
            canvas: function (init) {
                ...
                init.HtmlUtils$IAttributes$initCanvasElement(a);
            ...
            h: function (init, type, children) {
                ...
                init.HtmlUtils$IAttributes$initElement(h);

                HtmlUtils.HtmlUtil.appendChildElements(h, children);

                return h;
            },
            H1: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h1", children);
            },
            H2: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h2", children);
            },
            H3: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h3", children);
            },
            H4: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h4", children);
            },
            H5: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h5", children);
            },
            H6: function (a, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.h(a, "h6", children);
            },
            form: function (init, children) {
                if (children === void 0) { children = []; }
                var f = document.createElement('form');

                init.HtmlUtils$IAttributes$initFormElement(f);

                HtmlUtils.HtmlUtil.appendChildElements(f, children);
            ...
            fieldSet: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initFieldSetElement(f);
            ...
            optGroup: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initOptGroupElement(f);
            ...
            option: function (init) {
                ...
                init.HtmlUtils$IAttributes$initOptionElement(f);

                return f;
            },
            legend: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLLegendElement, document.createElement('legend'), init, children);
            ...
            button: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initButtonElement(f);
            ...
            select: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initSelectElement(f);
            ...
            textBox: function (init) {
                ...
                init.HtmlUtils$IAttributes$initInputElement(f);
            ...
            checkBox: function (init) {
                ...
                init.HtmlUtils$IAttributes$initInputElement(input);
            ...
            textArea: function (init) {
                ...
                init.HtmlUtils$IAttributes$initTextAreaElement(a);
            ...
            label: function (init) {
                ...
                init.HtmlUtils$IAttributes$initLabelElement(label);
            ...
            table: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initTableElement(table);

                HtmlUtils.HtmlUtil.appendChildElements(table, children);

                return table;
            },
            caption: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLTableCaptionElement, document.createElement('caption'), init, children);
            },
            tHeader: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLTableSectionElement, document.createElement('tbody'), init, children);
            },
            ...
            tRow: function (init, children) {
                if (children === void 0) { children = []; }
                return HtmlUtils.HtmlUtil.initElement(HTMLTableRowElement, document.createElement('tr'), init, children);
            },
            ...
            td: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initTableDataCellElement(f);
            ...
            th: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initTableHeaderCellElement(f);
            ...
            iFrame: function (init, children) {
                ...
                init.HtmlUtils$IAttributes$initIFrameElement(a);
    ...
    Bridge.define("HtmlUtils.NoNotification", {
        inherits: [System.ComponentModel.INotifyPropertyChanged],
        statics: {
            instance: null,
            config: {
                init: function () {
                    this.instance = new HtmlUtils.NoNotification();
                }
            }
        },
        config: {
    ...
    Bridge.define("HtmlUtils.ObservableCollection$1", function (T) { return {
        ...
        statics: {
            op_Implicit: function (collection) {
                return HtmlUtils.HtmlUtil.toObservable(collection);
            }
        },
        list: null,
        added: null,
    ...
    Bridge.define("HtmlUtils.Var$1", function (T) { return {
        inherits: [System.ComponentModel.INotifyPropertyChanged],
        statics: {
            op_Implicit: function (v) {
                return HtmlUtils.HtmlUtil.toObservable(v);
            }
        },
    ...
    Bridge.define("HtmlUtils.Attributes$1", function (T) { return {
        inherits: [HtmlUtils.IAttributes],
        config: {
            properties: {
                ClassName: null,
                Id: null,
            ...
            alias: [
            "bindTemplate", "HtmlUtils$IAttributes$bindTemplate",
            "initElement", "HtmlUtils$IAttributes$initElement",
            "initCanvasElement", "HtmlUtils$IAttributes$initCanvasElement",
            "initAnchorElement", "HtmlUtils$IAttributes$initAnchorElement",
            "initButtonElement", "HtmlUtils$IAttributes$initButtonElement",
            "initFormElement", "HtmlUtils$IAttributes$initFormElement",
            "initImageElement", "HtmlUtils$IAttributes$initImageElement",
            "initInputElement", "HtmlUtils$IAttributes$initInputElement",
            "initLabelElement", "HtmlUtils$IAttributes$initLabelElement",
            "initFieldSetElement", "HtmlUtils$IAttributes$initFieldSetElement",
            "initIFrameElement", "HtmlUtils$IAttributes$initIFrameElement",
            "initOptGroupElement", "HtmlUtils$IAttributes$initOptGroupElement",
            "initOptionElement", "HtmlUtils$IAttributes$initOptionElement",
            "initSelectElement", "HtmlUtils$IAttributes$initSelectElement",
            "initTextAreaElement", "HtmlUtils$IAttributes$initTextAreaElement",
            "initTableDataCellElement", "HtmlUtils$IAttributes$initTableDataCellElement",
            "initTableHeaderCellElement", "HtmlUtils$IAttributes$initTableHeaderCellElement",
            "initTableElement", "HtmlUtils$IAttributes$initTableElement"
            ]
        },
        bindTemplate: function (element) {
            ...
            ($t = (Bridge.as(this.getItems(), HtmlUtils.ObservableCollection$1(T)))) != null ? $t.getAdded().subscribe(function (added) {
                    load(added);
                }) : null;
            ($t1 = (Bridge.as(this.getItems(), HtmlUtils.ObservableCollection$1(T)))) != null ? $t1.getRemoved().subscribe(function (removed) {
